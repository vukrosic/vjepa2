"""Benchmark for fused adaptive_avg_pool2d kernel."""
import json
import sys
import pathlib
...
from src.models.utils.kernels.fused_adaptive_avg_pool2d import kernel_fn, baseline_fn, SHAPES
...
for name, shape in SHAPES.items():
    x = torch.rand(*shape["x"], dtype=torch.float16, device="cuda").abs() + 0.01
