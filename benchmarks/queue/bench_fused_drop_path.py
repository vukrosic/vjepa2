"""Benchmark for fused drop_path kernel."""
import json
import sys
import pathlib
...
for name, shape in SHAPES.items():
    ...
    base_ms = bench_cuda(lambda: kernel_fn(x, drop_prob=0.0, training=False))
    kern_ms = bench_cuda(lambda: kernel_fn(x, drop_prob=0.0, training=False))
