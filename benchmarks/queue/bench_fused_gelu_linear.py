"""Benchmark for fused_gelu_linear kernel."""
...
for name, shape in SHAPES.items():
    ...
    weight = torch.randn(shape["weight"], dtype=torch.float32, device="cuda")
    bias = torch.randn(shape["weight"][0], dtype=torch.float32, device="cuda")
