"""Benchmark for fused instance_norm kernel."""
import json
import sys
import pathlib
...
from src.models.utils.kernels.fused_instance_norm import kernel_fn, SHAPES
...
for name, shape in SHAPES.items():
    ...
    kern_fn = lambda: kernel_fn(x, weight, bias)
