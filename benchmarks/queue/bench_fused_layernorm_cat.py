"""Benchmark for fused_layernorm_cat kernel."""
...
for name, shape in SHAPES.items():
    ...
    base_ms = bench_cuda(lambda: baseline_fn(x, num_splits, weight, bias))
    kern_ms = bench_cuda(lambda: kernel_fn(x, weight, bias, num_splits))
