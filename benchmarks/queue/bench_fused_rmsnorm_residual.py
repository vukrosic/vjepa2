"""Benchmark for fused_rmsnorm_residual kernel."""
import json
import sys
import pathlib
import torch
...
for name, shape in SHAPES.items():
    ...
    base_ms = bench_cuda(lambda: baseline_fn(x, residual, weight))
    kern_ms = bench_cuda(lambda: kernel_fn(x, residual, weight))
