"""Parity test for fused_celu kernel."""
import torch, pytest
from src.models.utils.kernels.fused_celu import kernel_fn, baseline_fn, SHAPES
...
def test_forward_parity(shape_name, dtype):
    ...
    expected = baseline_fn(x, alpha=1.0)
    actual = kernel_fn(x, alpha=1.0)
...
def test_backward_parity(shape_name):
    ...
    out1 = baseline_fn(x1, alpha=1.0)
    out2 = kernel_fn(x2, alpha=1.0)
