"""Parity test for fused_leaky_relu kernel."""
import torch, pytest
from src.models.utils.kernels.fused_leaky_relu import kernel_fn, baseline_fn, SHAPES
...
def test_forward_parity(shape_name, dtype):
    ...
    expected = baseline_fn(x, 0.01)
    actual = kernel_fn(x, 0.01)
...
def test_backward_parity(shape_name):
    ...
    out1 = baseline_fn(x1, 0.01)
    out2 = kernel_fn(x2, 0.01)
