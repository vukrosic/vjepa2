"""Parity test for fused_masked_softmax_rope kernel."""
import torch
import pytest
import math
from src.models.utils.kernels.fused_masked_softmax_rope import kernel_fn, baseline_fn, SHAPES
...
def test_forward_parity(shape_name, dtype):
    ...
    # Only check lower triangle due to numerical differences in upper triangle
