"""Parity test for fused_pow kernel."""
import torch, pytest
from src.models.utils.kernels.fused_pow import kernel_fn, baseline_fn, SHAPES
...
def test_forward_parity(shape_name, dtype):
    ...
    expected = baseline_fn(x, p=2.0)
    actual = kernel_fn(x, p=2.0)
...
def test_backward_parity(shape_name):
    ...
    out1 = baseline_fn(x1, p=2.0)
    out2 = kernel_fn(x2, p=2.0)
