"""Parity test for fused_rms_norm kernel."""
import torch
import pytest
from src.models.utils.kernels.fused_rms_norm import kernel_fn, baseline_fn, SHAPES
...
def test_forward_parity(shape_name, dtype):
    ...
    expected = baseline_fn(x, weight)
    actual = kernel_fn(x, weight)
...
def test_backward_parity(shape_name):
    ...
    out1 = baseline_fn(x1, weight)
    out2 = kernel_fn(x2, weight)
