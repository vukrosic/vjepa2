"""Parity test for fused_scale kernel."""
import torch, pytest
from src.models.utils.kernels.fused_scale import kernel_fn, baseline_fn, SHAPES
...
def test_forward_parity(shape_name, dtype):
    ...
    expected = baseline_fn(x, 2.0)
    actual = kernel_fn(x, 2.0)
...
def test_backward_parity(shape_name):
    ...
    out1 = baseline_fn(x1, 2.0)
    out2 = kernel_fn(x2, 2.0)
