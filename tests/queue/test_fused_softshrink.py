"""Parity test for fused_softshrink kernel."""
import torch, pytest
from src.models.utils.kernels.fused_softshrink import kernel_fn, baseline_fn, SHAPES
...
def test_forward_parity(shape_name, dtype):
    ...
    expected = baseline_fn(x, lambd=0.5)
    actual = kernel_fn(x, lambd=0.5)
...
def test_backward_parity(shape_name):
    ...
    out1 = baseline_fn(x1, lambd=0.5)
    out2 = kernel_fn(x2, lambd=0.5)
