"""Parity test for fused_square_add_tensors kernel."""
import torch, pytest
from src.models.utils.kernels.fused_square_add_tensors import kernel_fn, baseline_fn, SHAPES
...
def test_forward_parity(shape_name, dtype):
    ...
    expected = baseline_fn(x, y)
    actual = kernel_fn(x, y)
...
def test_backward_parity(shape_name):
    ...
    out1 = baseline_fn(x1, y1)
    out2 = kernel_fn(x2, y2)
