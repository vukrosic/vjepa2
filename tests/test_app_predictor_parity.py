...
def test_app_predictor_rope_matches_head_baseline_cpu():
    baseline = load_module_from_head(ROOT, "app/vjepa_2_1/models/predictor.py", "baseline_app_predictor_rope")
    kwargs = _make_kwargs()
