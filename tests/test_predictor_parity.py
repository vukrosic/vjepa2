...
def test_src_predictor_matches_head_baseline_cpu_multi_mask():
    baseline = load_module_from_head(ROOT, "src/models/predictor.py", "baseline_src_predictor_multi")
    ...
    target_mask_indices = [
        torch.tensor([[2, 3], [0, 3]], dtype=torch.int64),
